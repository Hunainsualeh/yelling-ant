...
const QuizTypeTextInput: React.FC<Props> = ({ question, selectedAnswer, onAnswerSelect }) => {
  ...
  return (
    <div className="w-full flex justify-center">
      ...
      {question.image && (
        <div className="relative w-[798px] h-[384px] rounded-[8px] overflow-hidden mb-4">
      ...
      <div>
        <input
          ...
          className="w-[798px] h-[50px] px-4 py-3 rounded-[12px] border border-[#E5E7EB] text-gray-700 focus:outline-none"
        />
